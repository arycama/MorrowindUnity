...
public class SetupCameraOld : ViewRenderFeature
{
	...
	public SetupCameraOld(CustomRenderPipeline.RenderGraph renderGraph, LightingSettings lighting, MorrowindRenderPipelineAsset asset) : base(renderGraph)
	{
