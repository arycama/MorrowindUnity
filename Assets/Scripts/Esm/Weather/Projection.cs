...
[Serializable]
	...
	{
		[SerializeField, Tooltip("The y position you want the ocean")]
		private float oceanLevel = 0.0f;

		[SerializeField, Tooltip("The max height the waves will be displaced from ocean level")]
		private float maxHeight = 10.0f;

		public bool IsFlipped { get; private set; }

		public float OceanLevel { get { return oceanLevel; } set { oceanLevel = value; } }
		...
		/// </summary>
		Matrix4x4 m_projectorP = new Matrix4x4(), m_projectorV = new Matrix4x4();
