...
namespace Esm
{
	public class ProbeRecord : ItemRecord<ProbeRecordData>
	{
		public override SoundRecord PickupSound => Record.GetRecord<SoundRecord>("Item Probe Up");
		public override SoundRecord DropSound => Record.GetRecord<SoundRecord>("Item Probe Down");
